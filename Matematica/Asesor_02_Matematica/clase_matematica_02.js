...
const CREDENCIALES_ASESORES = {
    usuario: "matematica_02",
    password: "mate456@"
};

// Clave para almacenamiento
const STORAGE_KEY = "datos_clase_asesoria_matematica_02";

// Datos por defecto de la clase
const DATOS_CLASE_DEFAULT = {
    titulo: "Matemática Intermedia",
    tema: "Álgebra Lineal Aplicada",
    subtitulo: "Sesión práctica de Álgebra Lineal con ejercicios y aplicaciones reales",
    fecha: "2025-10-12",
    horaInicio: "16:00",
    horaFin: "17:00",
