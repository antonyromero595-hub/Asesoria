...
const CREDENCIALES_ASESORES = {
    usuario: "matematica_01",
    password: "mate123@"
};

// Clave para almacenamiento
const STORAGE_KEY = "datos_clase_asesoria_matematica_01";

// Datos por defecto de la clase
const DATOS_CLASE_DEFAULT = {
    titulo: "Matemática Avanzada",
    tema: "Cálculo Integral Avanzado",
    subtitulo: "Sesión interactiva de Cálculo Integral con enfoque práctico y resolución de problemas",
    fecha: "2025-10-11",
    horaInicio: "15:00",
    horaFin: "16:00",
